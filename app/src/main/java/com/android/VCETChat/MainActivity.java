...
import com.android.VCETChat.ui.FriendsFragment;
import com.android.VCETChat.ui.GroupFragment;
import com.android.VCETChat.ui.LoginActivity;
import com.android.VCETChat.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("VCETChat");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "VCETChat version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
